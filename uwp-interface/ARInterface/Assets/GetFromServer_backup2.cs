...
public class GetFromServer_BACKUP2 : MonoBehaviour {
    ...
    void Start()
    {
        ...
        crpiClient = new OldClient2(crpiIP, 20602);
...
//#if WINDOWS_UWP
public class OldClient2 : MonoBehaviour {
    ...
    //private SocketClientManager SCManager;
    ...
    public OldClient2(string ip, int prt)
    {
        path = ip;
        port = prt;
    ...
    public OldClient2(InputField IPin, int prt)
    {
        inputIP = IPin;
        port = prt;
    ...
    private void init()
    {
        //SCManager = new SocketClientManager();  // Do I need this??
    ...
    public void connect()
    {
        ...
        SocketClientManager.Host = path;

        SocketClientManager.Connect();

        SocketClientManager.Subscribe(msgID, WaitForData);
    ...
    private void WaitForData(NetworkMessage netMsg)
    {
        msgData = netMsg.ToString();
    }
    ...
    public string sendMsg(string msg)
    {
        ...
        NetworkMessage netMsg = new NetworkMessage(msgID, msgBytes);
        SocketClientManager.SendMessage(netMsg);
    ...
    {
        SocketClientManager.StopListening();
